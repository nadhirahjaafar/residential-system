...
if(isset($_POST['submit'])) {
    ...
    $sql= "INSERT INTO users (`name`, `address`, `ic no`, `tel no`, `vehicle reg no`, `username`, `password`, `email`, `role`)
    VALUES ('$name','$address', '$ic', '$telno', '$regno', '$username', '$password', '$email', '$role')";
...
<html lang="en">
<head>
  <title> REGISTRATION USER </title><!-- Meta, title, CSS, favicons, etc. -->
...
<div style="background-color:#30353E; height:650px; width:500px; border-radius:30px; text-align:center;" class="col-md-offset-4">
...
<div class="col-sm-12" style="padding-top:10px;">
<input type="text" class="form-control" id="ic" placeholder="Enter your address" name="address" style="border-radius:15px;">
</div>
<div class="col-sm-12" style="padding-top:10px;">
...
<div class="col-sm-12" style="padding-top:10px;" Select Type> 
    <select class="form-control" name="role" style= "border-radius: 15px;">
