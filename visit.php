...
if(isset($_POST['submit'])) {
    ...
    $sql= "INSERT INTO visit (`visitor name`,`resident name`,`relationship`, `resident address`, `time in`, `time out`)
    VALUES ('$vname','$rname','$relationship', '$raddress',  '$timein', '$timeout')";
...
<html lang="en">
<head>
  <title> VISITOR FORM </title><!-- Meta, title, CSS, favicons, etc. -->
                ...
                <div class="topbar-left">
                    <ol class="breadcrumb">
                        <li class="crumb-active">
                            <h2><label>Visitor form</label></h2>
                        </li>
                        <li class="crumb-icon">
                            <a href="index.php">
...
<div style="background-color:#30353E; height:500px; width:500px; border-radius:30px; text-align:center;" class="col-md-offset-4">
<h1 style="text-align:center; padding-top:30px; color:#ffffff;">VISIT FORM</h1>
<br>
<div class="col-sm-12" style="padding-top:10px;">
<input type="text" class="form-control" id="vname" placeholder="Visitor Name" name="vname" style="border-radius:15px;">
</div>
<div class="col-sm-12" style="padding-top:10px;">
<input type="text" class="form-control" id="rname" placeholder="Resident Name" name="rname" style="border-radius:15px;">
</div>

<div class="form-group">
    
<div class="col-sm-12" style="padding-top:10px;" Select Type> 
    <select class="form-control" name="relationship" style= "border-radius: 15px;">
...
<div class="col-sm-12" style="padding-top:10px;">
<input type="text" class="form-control" id="address" placeholder=" Resident Address" name="address" style="border-radius:15px;">
</div>

      <div class='col-sm-4'style="padding-top:10px;">
         <div class="form-group">
         <label for="Timein">Time In:</label>
            <div class='input-group time' id='timein'>
               <input type='time'  placeholder=" Time In" id="timein" name="timein" min="00:00" max="24:00" required style="border-radius:15px;"  class="form-control" />
      ...
      <div class='col-sm-4'style="padding-top:10px;">
         ...
         <label for="Timeout">Time Out:</label>
            <div class='input-group time' id='timeout'>
               <input type='time'  placeholder=" Time out" id="timeout" name="timeout" min="00:00" max="24:00" required style="border-radius:15px;"  class="form-control" />
