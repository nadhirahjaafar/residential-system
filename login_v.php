...
<html lang="en">
<head>
  <title> LOGIN VISITOR </title><!-- Meta, title, CSS, favicons, etc. -->
...
<div style="background-color:#30353E; height:450px; width:500px; border-radius:30px; text-align:center;" class="col-md-offset-4">
<h1 style="text-align:center; padding-top:30px; color:#ffffff;">WELCOME</h1>
<br> <br> <br>
...
<br><br><br> <br> <br> 
<div class="col-sm-12" style="padding-top:10px;">
<input type="password" class="form-control" id="password" placeholder=" &#128274; Enter your password" name="password" style="border-radius:15px;">
</div>
...
<br>
<a href="register_v.php" class="text-info" style= "color: softblue" >Register here</a>
