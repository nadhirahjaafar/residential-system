...
<html lang="en">
<head>
  <title> Logout </title><!-- Meta, title, CSS, favicons, etc. -->
  <meta charset="utf-8">
                ...
                <div class="topbar-left">
                    <ol class="breadcrumb">
                        <li class="crumb-active">
                            <h2><label>Logout</label></h2>
                        </li>
                        <li class="crumb-icon">
                            <a href="index.php">
                                <span class="fa fa-power-off pr5e"></span>
                            </a>
                        </li>
                    </ol>
                </div>
...
<h2><center> You are logged out. Please<a href= 'login_r.php'> Login </a></center></h2>
